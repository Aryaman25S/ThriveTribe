...
@router.post("/task/{user_name}", status_code=status_code=status.HTTP_201_CREATED, response_model=TaskResponse)
...
@router.get("/tasks/{user_name}", response_model=List[TaskResponse])
